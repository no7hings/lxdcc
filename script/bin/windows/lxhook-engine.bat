...
set QT_PLUGIN_PATH=%QT_PLUGIN_PATH%;%LXDCC_LIB_BASE%\bin\windows-x64-python-2.7.18-pyqt5-1\PyQt5\plugins
set QT_QPA_PLATFORM_PLUGIN_PATH=%QT_QPA_PLATFORM_PLUGIN_PATH%;%LXDCC_LIB_BASE%\bin\windows-x64-python-2.7.18-pyqt5-1\PyQt5\plugins\platforms
set LYNXI_BIN_PYTHON=%LXDCC_LIB_BASE%\bin\windows-x64-python-2.7.18\python

%LYNXI_BIN_PYTHON% %LXDCC_BASE%\script\bin\python-2.7\lxhook-engine.py %*