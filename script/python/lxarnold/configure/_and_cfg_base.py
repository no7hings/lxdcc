...
class Type(object):
    ...
    def get_name(cls, and_type):
        if and_type in AndCfgUtil.TYPE_NAME_QUERY:
            return AndCfgUtil.TYPE_NAME_QUERY[and_type]
...
class Node(object):
    ...
    def get_output_name(cls, and_type):
        return AndCfgUtil.OUTPUT_PORT_NAME_QUERY[and_type]
...
class Aov(object):
    ...
    def get_index(cls, type_name):
        return dict(AndCfgUtil.AOV_TYPES)[type_name]
