...
class AndNodeTypes(object):
    ...
    # geometry
    LYNXI_MESH_ARGS = AndNodeCategories.LYNXI, 'mesh'
    LYNXI_MESH = PATHSEP.join(LYNXI_MESH_ARGS)
    #
    LYNXI_CURVE_ARGS = AndNodeCategories.LYNXI, 'curve'
    LYNXI_CURVE = PATHSEP.join(LYNXI_CURVE_ARGS)
    #
    LYNXI_XGEN_DESCRIPTION_ARGS = AndNodeCategories.LYNXI, 'xgen_description'
    LYNXI_XGEN_DESCRIPTION = PATHSEP.join(LYNXI_XGEN_DESCRIPTION_ARGS)
    # material
    LYNXI_MATERIAL_ARGS = AndNodeCategories.LYNXI, 'material'
