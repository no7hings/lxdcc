...
class SVRange(object):
    def __init__(self, count, start=25.0):
        self._start = start
        self._p = (100.0-self._start)/count

    def get(self, index):
        return self._p*index+self._start
...
class RawStackOpt(object):
    def __init__(self, elements):
        self.__elements = elements
        self.__index_dict = {}
        for seq, i in enumerate(self.__elements):
