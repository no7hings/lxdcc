...
class DotMaFileReader(_AbsFileReader):
    SEP = ';\n'
    LINE_MATCHER_CLS = _LineMatcher
    FILE_REFERENCE_DICT = {
        'file': 'ftn',
        'reference': 'fn[0]',
        'xgmPalette': 'xfn',
...
class DotAssFileReader(_AbsFileReader):
    LINE_MATCHER_CLS = _LineMatcher
...
class DotUsdaFileReader(_AbsFileReader):
    SEP = '\n'
    LINE_MATCHER_CLS = _LineMatcher
