...
from ..core import configure as bsc_stg_cor_configure

from ..core import base as bsc_stg_cor_base
...
class StgConnector(object):
    ...
    StgEntityTypes = bsc_stg_cor_configure.StgEntityTypes
    #
    ...
    def __init__(self, **kwargs):
        self._stg_instance = bsc_stg_cor_base.StgBase().generate_connection()
    ...
    def get_stg_projects(self):
        return self._stg_instance.find(
            entity_type=bsc_stg_cor_configure.StgEntityTypes.Project,
            filters=[]
        ) or []
            ...
            if stg_version:
                _ = self._stg_instance.create(
                    'PublishedFile',
                    {
                        ...
                        "project": stg_project,
                        "entity": stg_entity,
                        "path_cache": bsc_core.StgBasePathMapMtd.map_to_current(file_path),
