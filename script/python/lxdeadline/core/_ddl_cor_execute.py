...
from lxdeadline.core import _ddl_cor_base
...
class DdlSubmiter(AbsDdlSubmiter):
    CON = _ddl_cor_base.DdlUtil.generate_connection()
    CONFIGURE_FILE_PATH = rsc_core.RscConfigure.get_yaml('session/deadline/submiter')
...
class DdlSubmiterForRsvProject(AbsDdlSubmiter):
    CON = _ddl_cor_base.DdlUtil.generate_connection()
    CONFIGURE_FILE_PATH = rsc_core.RscConfigure.get_yaml('session/deadline/rsv-project-submiter')
...
class DdlSubmiterForRsvTask(AbsDdlSubmiter):
    CON = _ddl_cor_base.DdlUtil.generate_connection()
    CONFIGURE_FILE_PATH = rsc_core.RscConfigure.get_yaml('session/deadline/rsv-task-submiter')
