...
class HoudiniShops(object):
    ...
    def get_output_vops(self):
        ...
        for shop in self._hou_shops:
            output_vops = HoudiniBasic.get_descendants(shop, include='Vop/arnold_material')
...
class HoudiniVops(object):
    ...
    def get_input_image_vops(self):
        ...
        for vop in self._hou_vops:
            image_vops = HoudiniBasic.get_all_inputs(vop, include='arnold::Vop/image')
            for i in image_vops:
                lis.append(i)
        return lis
