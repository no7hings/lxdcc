...
class Scene(utl_dcc_obj_abs.AbsObjScene):
    ...
    def _set_load_by_root_(self, root, include_obj_type):
        ...
        mya_root = _ma_dcc_obj_dag.Group(root_mya_dag_path.path)
    ...
    # clear
    @classmethod
    def set_unused_shader_clear(cls):
        mel.eval('MLdeleteUnused;')
    @classmethod
    def set_unused_window_clear(cls, exclude_window_names=None):
    ...
    def get_render_cameras(cls):
        ...
        for camera_path in _:
            camera = _ma_dcc_obj_dag.Camera(camera_path)
