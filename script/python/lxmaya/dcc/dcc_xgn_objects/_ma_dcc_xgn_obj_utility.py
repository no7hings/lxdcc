...
from lxmaya.dcc.dcc_objects import _ma_dcc_obj_os, _ma_dcc_obj_obj, _ma_dcc_obj_dag


class GrowMesh(_ma_dcc_obj_dag.Shape):
    ...
    def get_painter_file_nodes(self):
        ...
        for path in self.get_painter_file_node_paths():
            file_reference_node = _ma_dcc_obj_obj.TextureReference(path)
...
class Palette(XGenObj):
    ...
    def get_description_files(self):
        return [_ma_dcc_obj_os.OsFile(i) for i in self.get_description_file_paths()]
