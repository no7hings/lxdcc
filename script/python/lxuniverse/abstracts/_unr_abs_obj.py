        ...
        if self.get_is_exists() is True:
            ...
            for i_directory_path_tgt in target_dir_path:
                ...
                if os.path.exists(target_file_path) is False:
                    ...
                    log_core.Log.trace_warning('file copy: target "{}" is exist.'.format(target_file_path))
        else:
            log_core.Log.trace_warning('file copy: source "{}" is Non-exist.'.format(self.path))
