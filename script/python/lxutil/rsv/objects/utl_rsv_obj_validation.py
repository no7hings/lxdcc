...
class RsvDccValidationHookOpt(utl_rsv_obj_abstract.AbsRsvObjHookOpt):
    ...
    @classmethod
    def _set_dcc_texture_check_(cls, validator, check_group, dcc_objs):
    ...
    @classmethod
    def _set_dcc_texture_workspace_check_(cls, validator, check_group, dcc_objs, check_pattern_opts):
        from lxutil import utl_core
        #
        import lxutil.dcc.dcc_objects as utl_dcc_objects
    ...
    def set_shotgun_check(self, validator):
        ...
        if sgt_task_query is not None:
            ...
            if status in ['omt', 'hld']:
                validator.set_node_result_register(
                    location,
                    check_group=check_group,
                    check_status=validator.CheckStatus.Warning,
    ...
    def set_katana_texture_check(self, validator):
        ...
        if dcc_objs:
            self._set_dcc_texture_check_(validator, check_group, dcc_objs)
    ...
    def set_katana_texture_workspace_check(self, validator):
        ...
        if dcc_objs:
            self._set_dcc_texture_workspace_check_(
                validator, check_group,
                dcc_objs, check_pattern_opts
            )
    # maya
    def set_maya_scene_check(self, validator):
        def yes_fnc_():
    ...
    def set_maya_geometry_topology_check(self, validator):
        from lxbasic import bsc_core
        #
        from lxutil import utl_configure
        #
                        ...
                        if j_uv_map_face_vertex_indices:
                            if len(i_face_vertex_indices) != len(j_uv_map_face_vertex_indices):
                                ...
                                if j_uv_map_error_comps:
                                    validator.set_node_components_result_register(
                                        i_mesh_location,
    ...
    def set_maya_look_check(self, validator):
        from lxbasic import bsc_core
    ...
    def set_maya_texture_check(self, validator):
        import lxmaya.dcc.dcc_objects as mya_dcc_objects
        #
        import lxmaya.dcc.dcc_operators as mya_dcc_operators
        #
    ...
    def set_maya_texture_workspace_check(self, validator):
        import lxmaya.dcc.dcc_objects as mya_dcc_objects
        #
        import lxmaya.dcc.dcc_operators as mya_dcc_operators
        #
