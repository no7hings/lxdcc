...
class DdlUtil(object):
    # CONFIGURE = rsc_core.ResourceContent.get_as_content('deadline/main')
    # #
    ...
    def __generate_content(cls):
        if cls.CONTENT is not None:
            return cls.CONTENT
        cls.CONTENT = rsc_core.ResourceContent.get_as_content('deadline/main')
