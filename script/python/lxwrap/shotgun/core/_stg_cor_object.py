...
from ..core import _stg_cor_configure, _stg_cor_base
...
class StgConnector(object):
    ...
    StgEntityTypes = _stg_cor_configure.StgEntityTypes
    #
    ...
    def __init__(self, **kwargs):
        self._stg_instance = _stg_cor_base.StgUtil().generate_connection()
    ...
    def get_stg_projects(self):
        return self._stg_instance.find(
            entity_type=_stg_cor_configure.StgEntityTypes.Project,
            filters=[]
        ) or []
            ...
            if stg_version:
                _ = self._stg_instance.create(
                    'PublishedFile',
                    {
                        ...
                        "project": stg_project,
                        "entity": stg_entity,
                        "path_cache": bsc_core.StgBasePathMapper.map_to_current(file_path),
    ...
    def get_current_stg_user(cls):
        return StgConnector().get_stg_user(user=bsc_core.SystemMtd.get_user_name())
