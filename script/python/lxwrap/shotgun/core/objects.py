...
from ..core import configure as stg_cor_configure

from ..core import base as stg_cor_base
...
class StgConnector(object):
    ...
    StgEntityTypes = stg_cor_configure.StgEntityTypes
    #
    ...
    def __init__(self, **kwargs):
        self._stg_instance = stg_cor_base.StgUtil().generate_connection()
    ...
    def get_stg_projects(self):
        return self._stg_instance.find(
            entity_type=stg_cor_configure.StgEntityTypes.Project,
            filters=[]
        ) or []
