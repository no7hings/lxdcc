...
class TxrMethodForBuild(_AbsTxrMethod):
    ...
    def _generate_content(cls):
        if cls.CONTENT is not None:
            return cls.CONTENT
        cls.CONTENT = rsc_core.ResourceContent.get_as_content('texture/build')
...
class TxrMethodForColorSpaceAsAces(_AbsTxrMethod):
    ...
    def _generate_content(cls):
        if cls.CONTENT is not None:
            return cls.CONTENT
        cls.CONTENT = rsc_core.ResourceContent.get_as_content('texture/color-space/aces')
        cls.CONTENT.do_flatten()
        return cls.CONTENT
...
class TxrMethodForColorSpaceAsTxConvert(_AbsTxrMethod):
    ...
    def _generate_content(cls):
        if cls.CONTENT is not None:
            return cls.CONTENT
        cls.CONTENT = rsc_core.ResourceContent.get_as_content('texture/color-space/convert')
        cls.CONTENT.do_flatten()
        return cls.CONTENT
